<template>
  <div class="container">
    ...
    <buttons-layer>
      ...
      <navigation-button
        :link-to="{ name: 'vabaka-saal-2-pannoo' }"
      ...
      <navigation-button
        :link-to="{ name: 'vabaka-saal-2-pannoo-3' }"
        :position="{ top: '50%', left: '36%' }"
        icon="plus"
      />

      <navigation-button
        :link-to="{ name: 'vabaka-saal-2-pannoo-4' }"
        :position="{ top: '50%', left: '48%' }"
        icon="plus"
      />

      <navigation-button
        :link-to="{ name: 'vabaka-saal-2-pannoo-5' }"
        :position="{ top: '50%', left: '62%' }"
        icon="plus"
      />

      <navigation-button
        :link-to="{ name: 'vabaka-saal-2-lauad' }"
